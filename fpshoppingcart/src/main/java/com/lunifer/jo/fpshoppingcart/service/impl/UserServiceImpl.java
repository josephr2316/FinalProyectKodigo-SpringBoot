...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public UserResponse getAllUsers(int pageNo, int pageSize, String sortBy, String sortDir) {
        ...
        // Forzar la carga de la relación Order y Product
        listOfUsers.forEach(user -> {
            user.getOrderHistory().size(); // Forzar carga de la relación Order
            user.getOrderHistory().forEach(order -> order.getProductList().size()); // Forzar carga de la relación Product
        });
